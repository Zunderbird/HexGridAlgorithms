...
namespace Assets.MVC.Controllers
{
    class MapsGenController
    {
        ...
        public MapsGenController()
        {
            ...
            _mapsGenGui.HexMap.GetComponent<MouseActionsCatcher>().HexSelected += (args) => _mapsGenModel.SelectHex(args.HexCoord);
            _mapsGenGui.HexMap.GetComponent<MouseActionsCatcher>().HexHitted += (args) => _mapsGenModel.HitHex(args.HexCoord);
            ...
            //Models
            _mapsGenModel.HexCreated += (args) => _mapsGenGui.OnHexCreated(args.CubeCoord, args.HexCoord, args.HexType);
            _mapsGenModel.MapsCentreCoordsFound += (args) => _mapsGenGui.OnMapsCentreCoordsFound(args.CubeCoord);
            ...
            _mapsGenModel.IlluminateCurrentHex += (args) => _mapsGenGui.OnIlluminateCurrentHex(args.HexCoord);
            _mapsGenModel.IlluminateTargetHex += (args) => _mapsGenGui.OnIlluminateTargerHex(args.HexCoord);
            _mapsGenModel.SkipTargetHexIllumination += (args) => _mapsGenGui.OnSkipTargetHexIllumination(args.HexCoord);
            _mapsGenModel.SkipCurrentHexIllumination += (args) => _mapsGenGui.OnSkipCurrentHexIllumination(args.HexCoord);

            _mapsGenModel.PaintHex += args => _mapsGenGui.OnPaintHex(args.HexCoord, args.HexType);
